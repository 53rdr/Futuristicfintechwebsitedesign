...
```
  ...
  {/* FIX 1: Added pt-24 sm:pt-20 so content starts below the fixed navbar */}
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 sm:pt-20">
    ...
    >
      <h1 className="text-4xl sm:text-5xl lg:text-6xl tracking-tight mb-6 bg-gradient-to-r from-white via-[#BFBFBF] to-white bg-clip-text text-transparent">
        <span className="font-bold italic">{t.hero.title}</span>
      </h1>
    ...
    {/* FIX 2: YouTube embed using correct /embed/ URL format */}
    <motion.div
      ...
      <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-xl border border-[#00B7FF]/20 p-1 hover:border-[#00B7FF]/40 transition-all duration-300">
        <div className="relative" style={{ paddingBottom: '56.25%', height: 0 }}>
          <iframe
            ...
            src="https://www.youtube.com/embed/it-yc41Llmw"
